...
pub const SELECTED_PACK_HEADER_BOX_COLOR: [f32; 4] =
    [95.0 / 255.0, 104.0 / 255.0, 110.0 / 255.0, 1.0];
...
pub const DIFFICULTY_DISPLAY_INNER_BOX_COLOR: [f32; 4] =
    [15.0 / 255.0, 15.0 / 255.0, 15.0 / 255.0, 1.0]; // #0f0f0f
...
pub const DIFFICULTY_TEXT_COLOR_BEGINNER: [f32; 4] =
    [255.0 / 255.0, 190.0 / 255.0, 0.0 / 255.0, 1.0]; // #FFBE00
...
pub const DIFFICULTY_TEXT_COLOR_CHALLENGE: [f32; 4] =
    [255.0 / 255.0, 71.0 / 255.0, 179.0 / 255.0, 1.0]; // #FF47B3 (Matches one of the pack palette colors too)
