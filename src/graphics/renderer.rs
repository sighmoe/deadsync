        ...
        for char_code in text.chars() {
            ...
            if let Some(glyph_info) = font.get_glyph(char_code) {
                ...
                if char_code == 'A' {
                    ...
                    debug!(" GlyphInfo: plane_left={:.2}, plane_bottom={:.2}, plane_right={:.2}, plane_top={:.2}, advance={:.2}", glyph_info.plane_left, glyph_info.plane_bottom, glyph_info.plane_right, glyph_info.plane_top, glyph_info.advance);
                    debug!(
